...
extension Defaults.Keys {
  ...
  static let activeFilter = Key<ClipboardFilter>("activeFilter", default: .all)
  ...
  static let windowSize = Key<NSSize>("windowSize", default: NSSize(width: 520, height: 760))
  ...
  static let previewWidth = Key<CGFloat>("previewWidth", default: 520)
}
